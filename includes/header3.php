...
//USE ONLY WITHOUT header.php. THIS HEADER IS DESIGNED FOR PAGES THAT DO NOT REQUIRE A TOP BANNER IMAGE, OR WHERE THIS SPACE SHOULD CONTAIN INFORMATION. 	<div class= "top_banner"></div> <div class="wrapper"> should be added to the top page where this header is used 
...
<body>
	...
	<div class="top_bar">
			...
			?>
						<button onclick="myFunction()" class="menu_settings"> </button>
						    ...
						    <a href="settings.php"> 
				            		<img src="assets/images/icons/wrench.png" class="icon_position"                                 
				            	 	onmouseover="this.src='assets/images/icons/wrenchh.png'"
				                	onmouseout="this.src='assets/images/icons/wrench.png'" title= "Configuracion"/>            
				            	 	Configuración
				            	</a>
				                ...
				                onmouseout="this.src='assets/images/icons/pay.png'" title= "Ajustes"/>            
				            	 	Pagos
				            	</a>
								...
								<a href="health_info_input.php"> 
				                    ...
				                    onmouseout="this.src='assets/images/icons/medhist.png'" title= "Historia Med."/>            
				            	 	Info. Médica
				            	</a>
				            	<?php }?>
        ...
        <navb>
            ...
            <a href="#"> <img src="<?php echo $txt_rep->entities($user_obj->getProfilePicFast()); ?>"> </a>   
		...
		<nav>
			...
			?>
			<a href="index.php"> <img src="assets/images/icons/home.png" class="icon_position"
                onmouseover="this.src='assets/images/icons/homeh.png'"
                onmouseout="this.src='assets/images/icons/home.png'" title= "Inicio"/>
            </a>
			...
			<?php
				$notifications_icon_disp = '<a href="requests.php">';
				
				if($num_friend_requests > 0)
					$notifications_icon_disp .= '<span class="notification_badge" id="unread_fri_req">' . $txt_rep->entities($num_friend_requests) . '</span>';
			
				$notifications_icon_disp .= <<<EOS
