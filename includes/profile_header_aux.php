...
//THIS HEADER is used for pages where you want to show the same top banner as the profile, like connections.
//NOTE:!This is a PUBLIC HEADER, meaning users do not need to be logged in.
...
if(isset($_GET['profile_username'])){
	...
	if( !preg_match("/^[a-zA-Z0-9\-]+$/", $_GET['profile_username']) )
	{
		...
		$profile_given_id = $_GET['profile_username'];
	}
...
<div class = "wrapper_top" style="position: absolute;top: 30px;">		
